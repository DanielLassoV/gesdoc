            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h3 class="fl"><i class="fa-solid fa-file-invoice"></i></i></i> Registrar tipo de documento </h3>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form class="needs-validation" novalidate method="POST" action="{{ route('tipoDocumento.store') }}">
                            ...
                            <a type="button" href="{{ route('tipoDocumento.index') }}" class="btn btn-secondary"> Cancelar
                            </a>
                        </form>
                    </div>
                </div>
