            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form class="needs-validation" novalidate method="POST" action="{{ route('departamento.store') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input placeholder="Ingresar la direccion" type="text" class="form-control" id="direccion"
